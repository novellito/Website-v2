      ...
      <div className="row aboutsMe">
                <div className="infoCol fromLeft" ref='fromLeft'>
                    ...
                    <div className="personalLinks">
                        <a href="https://github.com/novellito" alt="my github"><i className="fa fa-github-alt social-ink"
                        data-toggle="tooltip" data-placement="top" title = "View my GitHub"></i></a>
                        <a href="mailto:cntrinidad@gmail.com" alt="email me"><i className="fa fa-envelope-open" data-toggle="tooltip" data-placement="top" title = "Email Me"></i></a>
                        <a href="https://www.linkedin.com/in/christian-trinidad07/" alt="my linked in"><i className="fa fa-linkedin-square social-ink" 
                ...
                <div className="rt-col " ref='fromRight'>
                    ...
                    <a href="#x"><button className="resume fromRight" ref='fromRight'><i className="fa fa-download" ></i>   Download Resume (PDF)</button></a>
                </div>
                 <div className="personalLinks mini">
                        <a href="https://github.com/novellito"><i className="fa fa-github-alt social-ink"
                        data-toggle="tooltip" data-placement="top" title = "View my GitHub"></i></a>
                        ...
                        <a href="https://www.linkedin.com/in/christian-trinidad07/"><i className="fa fa-linkedin-square social-ink" 
                        data-toggle="tooltip" data-placement="top" title = "View my LinkedIn"></i></a>
                    </div>
            </div>
    );
